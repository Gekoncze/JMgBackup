...
public @Test class TreeIteratorTest {
    ...
    private void testEmpty() {
        ...
        treeIterator.forEachNode((Node) null, this::fail, nodeProgress);
        ...
        treeIterator.forEachFile((Node) null, this::fail, fileProgress);
        ...
        treeIterator.forEachDirectory((Node) null, this::fail, directoryProgress);
    ...
    private void testFile() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(file, this::add, nodeProgress);
        ...
        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(file, this::add, fileProgress);
        ...
        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(file, this::add, directoryProgress);
    ...
    private void testDirectory() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(directory, this::add, nodeProgress);
        ...
        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(directory, this::add, fileProgress);
        ...
        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(directory, this::add, directoryProgress);
    ...
    private void testNestedDirectories() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(directory1, this::add, nodeProgress);
        ...
        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(directory1, this::add, fileProgress);
        ...
        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(directory1, this::add, directoryProgress);
    ...
    private void testFiles() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(files, this::add, nodeProgress);
        ...
        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(files, this::add, fileProgress);
        ...
        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(files, this::add, directoryProgress);
    ...
    private void testDirectories() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(directories, this::add, nodeProgress);
        ...
        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(directories, this::add, fileProgress);
        ...
        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(directories, this::add, directoryProgress);
    ...
    private void testEmptyCollection() {
        ...
        Progress nodeProgress = new Progress("test");
        treeIterator.forEachNode(directories, this::fail, nodeProgress);

        Assert.assertEquals(0L, nodeProgress.getLimit());
        Assert.assertEquals(0L, nodeProgress.getValue());

        Progress fileProgress = new Progress("test");
        treeIterator.forEachFile(directories, this::fail, fileProgress);

        Assert.assertEquals(0L, fileProgress.getLimit());
        Assert.assertEquals(0L, fileProgress.getValue());

        Progress directoryProgress = new Progress("test");
        treeIterator.forEachDirectory(directories, this::fail, directoryProgress);
